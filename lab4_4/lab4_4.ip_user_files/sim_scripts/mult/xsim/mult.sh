...
#
# Generated by Vivado on Sat Mar 29 19:04:10 +0100 2025
...
# Script info
echo -e "mult.sh - Script generated by export_simulation (Vivado v2022.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L xbip_bram18k_v3_0_6 -L mult_gen_v12_0_18 -L xil_defaultlib -L secureip -L xpm --snapshot mult xil_defaultlib.mult -log elaborate.log
}
