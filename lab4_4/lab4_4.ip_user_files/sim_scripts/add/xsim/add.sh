...
#
# Generated by Vivado on Sat Mar 29 19:01:48 +0100 2025
...
# Script info
echo -e "add.sh - Script generated by export_simulation (Vivado v2022.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xbip_utils_v3_0_10 -L c_reg_fd_v12_0_6 -L xbip_dsp48_wrapper_v3_0_4 -L xbip_pipe_v3_0_6 -L xbip_dsp48_addsub_v3_0_6 -L xbip_addsub_v3_0_6 -L c_addsub_v12_0_14 -L xil_defaultlib -L secureip -L xpm --snapshot add xil_defaultlib.add -log elaborate.log
}
