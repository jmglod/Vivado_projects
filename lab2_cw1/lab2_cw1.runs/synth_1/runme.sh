...
HD_PWD='C:/VivadoProjects/lab2_cw1/lab2_cw1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log long_and.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source long_and.tcl
