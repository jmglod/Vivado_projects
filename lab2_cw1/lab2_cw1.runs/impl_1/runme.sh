...
HD_PWD='C:/VivadoProjects/lab2_cw1/lab2_cw1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log long_and.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source long_and.tcl -notrace
